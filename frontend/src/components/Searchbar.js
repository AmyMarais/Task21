...
require('isomorphic-fetch'); //in order to use fetch we install 'isomorphic-fetch'
    ...
    render() {
        return (
            <div className='search-form' id='Search'>
                <h1 style={{fontSize: '40px', color: 'white'}}>Search </h1>
                <form className='search-bar-form' onSubmit={this.handleSubmit}>
                    ...
                    <button type='submit' style={{ backgroundColor: 'darkorange'}} className='btn btn-m btn-info mb-3'>Search <i className='fa fa-search'></i></button>
                </form>
